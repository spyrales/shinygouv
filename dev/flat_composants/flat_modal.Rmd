...
#' @return html
#' @noRd
modalDialog_dsfr_template <- function(inputId = "fr-modal-1",
  title, 
  body, 
  footer = NULL
  ){
...
modalDialog_dsfr(
  ...
  footer = actionButton_dsfr(inputId = "Bouton",
                             label = "Bouton")
)
...
fusen::inflate(flat_file = "dev/flat_composants/flat_modal.Rmd", 
                vignette_name = "modalDialog_dsfr")
```
