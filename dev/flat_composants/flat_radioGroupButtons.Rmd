...
Cette fonction repose sur `radioGroupButtons_unique_dsfr_template()` qui devra être répeter autant de fois qu'il y a de choix (utilisation de `purrr::map(...)`)
...
#' @return html
radioGroupButtons_dsfr_template <- function(inputId, label, choix, selected = NULL, inline = FALSE
  ){
...
#' 
#' @export
updateRadioGroupButtons_dsfr <- function(inputId,
                                    label = NULL,
                                    choices = NULL,
                                    selected = NULL,
                                    inline = FALSE,
...
if (interactive()) {
ui <- fluidPage_dsfr(
  radioGroupButtons_dsfr(inputId = "inradioGroupButtons", 
...
fusen::inflate(
  ...
  vignette_name = "radioGroupButtons_dsfr",
  check = FALSE,
  overwrite = TRUE,
  open_vignette = FALSE
)
