...
- Un mot clé en début de message pour dire le principal objectif de ce commit.
...
En plus des dépendances du package, un ensemble de packages sera nécéssaire pour le bon developpement du package.

Vous retrouverez cette liste dans le fichier `dev/pkgs_deps.csv`.

## Workflow avant de commit

Pensez à executer les lignes suivantes du fichier `dev/dev_history_package.R` :
