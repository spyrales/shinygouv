...
vignette: >
  %\VignetteIndexEntry{Dev-D-retour-sur-shiny.dsfr}
...
Suite à la recommandation adoptée par le client, à savoir l'option D de la vignette `Recommandation`, voici les différents points d'explication sur la méthodologie complémentaire retenue par nos soins en comparaison de {shiny.dsfr} :
...
- Deuxièment, dans la mesure du possible, nous souhaiterions ne pas avoir à recoder les `inputs-bindings` de shiny. Pour cela, on réutilisera les classes déjà existantes dans {shiny}.
