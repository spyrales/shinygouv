...
Ceci est un dossier de documentation dédié aux développeurs et développeuses. Il contient les choix de mode de développement et tout autre guide qui ne s'adresserait pas directement aux utilisateurs.

## Contribuer à {shinygouv} - Introduction

Ces quelques lignes expliquent comment contribuer à {shinygouv}.  

Pour des contributions au code de ce projet, svp regardez la documentation à l'intention du développeur dans 
...
En plus des dépendances du package, un ensemble de packages sera nécessaire pour le bon développement du package.
