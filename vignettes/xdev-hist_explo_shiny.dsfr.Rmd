...
vignette: >
  %\VignetteIndexEntry{xdev-hist_explo_shiny.dsfr}
...
Suite à la recommandation adoptée par le client, à savoir l'option D de la vignette [Recommandations](xdev-hist_recommandation-pour-l-implementation-de-dsfr), voici les différents points d'explication sur la méthodologie complémentaire retenue par nos soins en comparaison de {shiny.dsfr} :
...
Néanmoins, nous allons nous inspirer du package {shiny.dsfr} qui apporte une logique métier dans certains composants déjà implémentés. 
